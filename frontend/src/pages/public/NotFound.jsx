  ...
  return (
    <section className="section-padding">
      <div className="page-container max-w-xl text-center">
        ...
        <p className="mt-4 text-muted-foreground">Puede que la dirección haya cambiado o que el enlace ya no exista.</p>
        <Button className="mt-7" asChild><Link to="/">Volver al inicio</Link></Button>
      </div>
    </section>
  )
}
